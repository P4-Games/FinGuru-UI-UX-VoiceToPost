...
export default function Home() {
  return (
    <main className="flex flex-col items-center justify-between p-12 sm:p-24 gap-12">
      <img
        src="/title_logo_fin.png"
        alt="Logo"
        className="w-[140px] opacity-[0.5]"
      />
      ...
      <p className="sm:w-[50%] w-[90%] text-center text-xl">
        Solo grabando una nota de voz, nos encargamos de entregarte un articulo
        de calidad listo para publicar. Gane tokens cada vez que tu artículo
        recibe una visita.
      </p>
